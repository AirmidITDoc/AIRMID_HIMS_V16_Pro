...
export class UpdatedeliveryComponent implements OnInit {
  ...
  calculateLastDay(inputDate: string) {
    ...
    if (inputDate && inputDate.length === 6) {
      ...
      if (month >= 1 && month <= 12) {
        ...
        this._DeliveryService.userFormGroup.get('ExpDatess').setValue(this.vlastDay)
        this.setFocus('Qty');
      } else {
  ...
  gePharStoreList() {
    ...
    this._DeliveryService.getLoggedStoreList(vdata).subscribe(data => {
     ...
     // console.log(this.StoreList)
      this._DeliveryService.DeliveryStoreForm.get('StoreId').setValue(this.StoreList[0]);
    });
  }
  getGSTtypeList() {
    var vdata = {
    ...
    this._DeliveryService.getGSTtypeList(vdata).subscribe(data => {
      this.GSTTypeList = data;
       ...
       if (this.data) {
        ...
        this._DeliveryService.userFormGroup.get('GSTType').setValue(toSelectGSTType);
        this._DeliveryService.userFormGroup.get('GSTType').setValue(this.GSTTypeList[0]);
  ...
  getSupplierSearchCombo() {
    ...
    else if (this.data.chkNewDelivery == 2) {
    ...
    this._DeliveryService.getSupplierSearchList(m_data).subscribe(data => {
      ...
      if (this.data.chkNewDelivery == 2) {
        ...
        this._DeliveryService.userFormGroup.get('SupplierId').setValue(toSelectSUpplierId);
        ...
        this._DeliveryService.userFormGroup.get('SupplierId').setValue(this.filteredOptionssupplier[0]);
      }
  ...
  getDeliveryItemList() {
    ...
    this._DeliveryService.getItemNameList(m_data).subscribe(data => {
  ...
  calculateTotalamt() {
    ...
    if (Qty > 0 && this.vRate > 0) {
      ...
      this._DeliveryService.userFormGroup.get('TotalAmount').setValue(0);
      this._DeliveryService.userFormGroup.get('DisAmount').setValue(0);
      this._DeliveryService.userFormGroup.get('DisAmount2').setValue(0);
      this._DeliveryService.userFormGroup.get('CGSTAmount').setValue(0);
      this._DeliveryService.userFormGroup.get('SGSTAmount').setValue(0);
      this._DeliveryService.userFormGroup.get('GSTAmount').setValue(0);
      this._DeliveryService.userFormGroup.get('NetAmount').setValue(0);
    }
  ...
  calculateDiscperAmount() {
    ...
    if (disc >= 0) {
      ...
      if (this._DeliveryService.userFormGroup.get('GSTType').value.Name == 'GST Before Disc') {
  ...
  OnchekPurchaserateValidation() {
    ...
    if (this.vRate) {
      if (parseFloat(this.vRate) <= parseFloat(this.vMRP)) {
        ...
        this._DeliveryService.userFormGroup.get('Rate').setValue(0);
        this._DeliveryService.userFormGroup.get('TotalAmount').setValue(0);
        this._DeliveryService.userFormGroup.get('DisAmount').setValue(0);
        this._DeliveryService.userFormGroup.get('DisAmount2').setValue(0);
        this._DeliveryService.userFormGroup.get('CGSTAmount').setValue(0);
  ...
  calculateGSTType(event) {
    if (event.value.Name == "GST After Disc") {
      ...
      this.vNetAmount = (parseFloat(this.vTotalAmount) - parseFloat(this._DeliveryService.userFormGroup.get('DisAmount').value) + parseFloat(this.vGSTAmount)).toFixed(2);
      this._DeliveryService.userFormGroup.get('NetAmount').setValue(this.vNetAmount);
    }
  ...
  onAdd() {
    ...
    const isDuplicate = this.dsItemNameList.data.some(item => item.BatchNo === this._DeliveryService.userFormGroup.get('BatchNo').value);
      ...
      this.chargeslist.push(
        {
          ...
          ItemName: this._DeliveryService.userFormGroup.get('ItemName').value.ItemName || '',
    ...
    this._DeliveryService.userFormGroup.get('ItemName').setValue('');
    this.vNetAmount = 0;
  ...
  OnReset() {
    this._DeliveryService.userFormGroup.reset();
  ...
  OnSavePO() {
    ...
    if (this._DeliveryService.DeliveryFinalForm.invalid) {
    ...
    grnSaveObj['gateEntryNo'] = this._DeliveryService.userFormGroup.get('GateEntryNo').value || 0;
    grnSaveObj['cash_CreditType'] = this._DeliveryService.userFormGroup.get('PaymentType').value;
    grnSaveObj['grnType'] = this._DeliveryService.userFormGroup.get('GRNType').value;
    grnSaveObj['totalAmount'] = this._DeliveryService.DeliveryFinalForm.get('TotalAmt').value || 0;
    grnSaveObj['totalDiscAmount'] = this._DeliveryService.DeliveryFinalForm.get('DiscAmount').value || 0;
    grnSaveObj['totalVATAmount'] = this._DeliveryService.DeliveryFinalForm.get('VatAmount').value || 0;
    grnSaveObj['netAmount'] = this._DeliveryService.DeliveryFinalForm.get('NetPayamt').value || 0;
    grnSaveObj['remark'] = this._DeliveryService.DeliveryFinalForm.get('Remark').value || '';
    ...
    grnSaveObj['otherCharge'] = this._DeliveryService.DeliveryFinalForm.get('OtherCharge').value || 0;
    grnSaveObj['roundingAmt'] = this._DeliveryService.DeliveryFinalForm.get('RoundingAmt').value || 0;
    ...
    grnSaveObj['tranProcessId'] = this._DeliveryService.userFormGroup.get('GSTType').value.ConstantId || 0;
    grnSaveObj['tranProcessMode'] = this._DeliveryService.userFormGroup.get('GSTType').value.Name || '';
    grnSaveObj['ewayBillNo'] = this._DeliveryService.DeliveryFinalForm.get('EwayBillNo').value || 0;
    grnSaveObj['ewayBillDate'] = this.datePipe.transform(this._DeliveryService.DeliveryFinalForm.get('EwalBillDate').value, "yyyy-MM-dd") || '01/01/1099';
    ...
    this._DeliveryService.POtoGRNSave(submitData).subscribe(response => {
      if (response) {
  ...
  OnEditPO() {
    ...
    console.log(submitData);
    this._DeliveryService.POtoGRNUpated(submitData).subscribe((data) => {
      console.log(data)
      if (data) {
  ...
  OnSavenew() {
    ...
    console.log(submitData);
    this._DeliveryService.GRNSave(submitData).subscribe(response => {
      if (response) {
  ...
  OnSaveEdit() {
    ...
    updateGRNHeaderObj['gateEntryNo'] = this._DeliveryService.userFormGroup.get('GateEntryNo').value || 0;
    updateGRNHeaderObj['cash_CreditType'] = this._DeliveryService.userFormGroup.get('PaymentType').value;
    updateGRNHeaderObj['grnType'] = this._DeliveryService.userFormGroup.get('GRNType').value;
    updateGRNHeaderObj['totalAmount'] = this._DeliveryService.DeliveryFinalForm.get('TotalAmt').value || 0;
    updateGRNHeaderObj['totalDiscAmount'] = this._DeliveryService.DeliveryFinalForm.get('DiscAmount').value || 0;
    updateGRNHeaderObj['totalVATAmount'] = this._DeliveryService.DeliveryFinalForm.get('VatAmount').value || 0;
    ...
    updateGRNHeaderObj['otherCharge'] = this._DeliveryService.DeliveryFinalForm.get('OtherCharge').value || 0;
    updateGRNHeaderObj['roundingAmt'] = this._DeliveryService.DeliveryFinalForm.get('RoundingAmt').value || 0;
    ...
    updateGRNHeaderObj['tranProcessId'] = this._DeliveryService.userFormGroup.get('GSTType').value.ConstantId || 0;
    ...
    console.log(submitData);
    this._DeliveryService.GRNEdit(submitData).subscribe(response => {
      if (response) {
  ...
  public onEnterDisc(event): void {
    if (event.which === 13) {
      if (this._DeliveryService.userFormGroup.get('GSTType').value.Name == "GST After TwoTime Disc") {
        this.isDisc2Selected = true;
  ...
  viewGRNREPORTPdf(el) {
    ...
    setTimeout(() => {
      ...
      this.AdList = true;
      this._DeliveryService.getPdfGRN(el).subscribe(res => {
