...
public AdmissionInsert(employee)
{    
...
{    
  return this._httpClient.post("InPatient/AdmissionSave",employee);
}
// public admissionNewInsert(employee)
// {
//   return this._httpClient.post("InPatient/AdmissionSave",employee);
// }
// public bedUpdate(employee)
// {
//   return this._httpClient.post("InPatient/AdmissionSave",employee);
// }
//-------------------Insert methods-----------
...
//CountryName Combobox List
  ...
  // public casepaperVisitDetails(visistId) {
  //   return this._httpClient.post("Generic/GetByProc?procName=rtrv_CaseparVisitDetails",{"VisitId": visistId});
  // }
